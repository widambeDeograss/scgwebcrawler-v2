...
class LinkedinspiderSpider(scrapy.Spider):
    name = 'LinkedInSpider'
    allowed_domains = ['millardayo.com']
    ...
    def start_requests(self):
        ...
        for profile in profile_list:
            ...
            yield scrapy.Request(url=linkedin_people_url, callback=self.parse_profile,
                                 meta={'profile': profile, 'linkedin_url': linkedin_people_url}, headers={"User_Agent": user_agent_list[randint(0, len(user_agent_list)-1)]})
